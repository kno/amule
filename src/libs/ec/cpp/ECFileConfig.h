...
/**
 * Extension to wxFileConfig for reading and writing CMD4Hash values. Converts between the text and
 * binary representation of an MD4 hash, and maps the empty string to the empty hash and back.
 */
