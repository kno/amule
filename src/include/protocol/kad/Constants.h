...
// The concurrent-file cap (formerly KADEMLIATOTALFILE) and per-file re-search interval (formerly
// KADEMLIAREASKTIME) are now preferences: thePrefs::GetKadMaxSourceSearches() and
// GetKadSourceReaskTime().
