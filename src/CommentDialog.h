...
public:
	...
	// CKnownFile is destroyed. Pointer-value comparison only, `file` may already be freed. Open
	// dialogs whose m_file matches are dismissed, their state no longer corresponding to
	// anything on disk. Wired into MuleNotify::KnownFileBeingDestroyed (GuiEvents.cpp).
